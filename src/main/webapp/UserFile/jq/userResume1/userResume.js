...
function goTo() {
	 ...
	 * 点击编辑简历 进行跳转
	 */
	$(".userInfo div:last-child ul li:nth-child(2)").click(function() {
		window.location.replace($("#PageContext").val()+"user_checkResume");
	})
	/**
	 * 点击编辑简历 进行跳转
	 */
	$(".userInfo div:last-child ul li:nth-child(3)").click(function() {
		$.ajax({
			type:"post",
			url:"",
			data:{"r_id":r_id},
