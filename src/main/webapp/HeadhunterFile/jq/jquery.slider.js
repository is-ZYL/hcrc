	...
	$.fn.slider = function (options) {
		...
		return this.each (function(){
			var defaultValue = {
				...
				source: [
							{
								src: "https://www.lgstatic.com/i/image3/M00/25/49/CgpOIFqXceeAFxGAAAk40VkL9gc007.PNG",									// 幻灯片图片地址
								hasHref: true,												// 是否有链接
								href: '#',			// 链接地址					
								hrefTarget: '_self'											// 链接打开方式  _self, _blank, _top等
 							},
							{
                        src: 'https://www.lgstatic.com/i/image3/M00/25/DA/CgpOIFqXwgCANgdqAA1yzkJ2JQg253.JPG',
                        hasHref: false,
                        hrefTarget: '_self',
							},
							{
                        src: 'https://www.lgstatic.com/i/image3/M00/25/A8/CgpOIFqXqOuAcd0HAApG-4doay4699.JPG',
                        hasHref: false,
                        hrefTarget: '_self',
							},
						]
